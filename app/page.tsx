...
export default function Home() {
    return (
        <div className="flex bg-black min-h-screen ">
            <main className="sm:mt-6 lg:mt-8 mt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <div className="sm:text-center lg:text-left">
                        <h1 className="text-4xl tracking-tight font-extrabold text-gray-800 sm:text-5xl md:text-6xl">
                            <span className="block xl:inline">BOLETÍN</span>
                            <span className="block text-indigo-600 xl:inline">Del Sistema de Gestión Ambienta</span>
                        </h1>
                        <p
