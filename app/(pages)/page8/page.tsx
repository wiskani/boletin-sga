                        ...
                        <div className="w-full flex justify-center">
                            ...
                            <div className="flex flex-col md:flex-row items-center">
                                ...
                                <div className="order-2 md:order-1 text-center md:text-left">
                                    ...
                                    <h2 className="title text-gray-100">{articles[8].title}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="px-4 md:px-8 lg:px-12 mt-12 text-gray-700 text-lg leading-relaxed">
                    ...
                    >
                        <div className="flex flex-col gap-y-7">
                            ...
                            <section className="mx-5 ">
                                <div>
                                    <p className="paragraph font-bold">
                                        {hazardMaterial.definition.title}
                                    </p>
                                    ...
                                    <ul className="list-disc pl-7 md:pl-9 space-y-2 md:space-y-3 paragraph marker:text-[1.1em] md:marker:text-[1.25em] marker:text-gray-500 dark:marker:text-gray-400">
                                        ...
                                        <li>
                                            <Link
                                                ...
                                                className="hover:underline underline-offset-4"
                                            >
                                                2-I-1002 Atención de Emergencias Ambientales,
                                                relacionadas con Almacenamiento de Sustancias o Residuos
                                                Peligrosos
                                            </Link>
                                        </li>
                                    </ul>
                            ...
                            {/* CLOSING  */}
                            <section className="border-t-2 border-custom2025DeepOrange mt-8 pt-6">
                                {hazardMaterial.closing.map((text, i) => (
                                    <p key={i} className="paragraph">
                                        {text}
                                    </p>
                                ))}
                            ...
                            <section className=" items-center justify-center ">
                                <Image
                                    src="/images/sustancias_pe_closing.jpg"
                                    alt="Mono"
                                    width={300}
                                    height={150}
